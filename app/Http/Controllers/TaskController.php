...
class TaskController extends Controller
{
    ...
    public function update(Task $task, Request $request)
    {
        ...
        $request->session()->flash('task-update-success', 'Task with title "' . $inputs['title'] . '" was updated');
    ...
    public function destroy(Task $task, Request $request)
    {
        ...
        $task->delete();
        // $board->tasks()->delete();
        $request->session()->flash('task-delete', 'Task with title "' . $task->title . '" was deleted');
        return back();
    }
